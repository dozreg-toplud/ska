...
++  double-int
  ...
  ?.  |(?=(^ cape.sock.a) ?=(^ cape.sock.b) ?=(^ src.a) ?=(^ src.b))
    [*sock *spring]
  ~+
  =/  h  $(sock.a ~(hed so sock.a), sock.b ~(hed so sock.b), src.a (hed:source src.a), src.b (hed:source src.b))
  =/  t  $(sock.a ~(tel so sock.a), sock.b ~(tel so sock.b), src.a (tel:source src.a), src.b (tel:source src.b))
  [(~(knit so sock.h) sock.t) (cons-spring:source src.h src.t)]
::
--
::
|=  [bus=sock fol=^]
